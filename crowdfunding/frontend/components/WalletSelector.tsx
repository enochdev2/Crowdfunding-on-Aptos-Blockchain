...
export function WalletSelector() {
  ...
  return connected ? (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="bg-fuchsia text-white" >
...
function ConnectWalletDialog({ close }: ConnectWalletDialogProps) {
  ...
  return (
    <DialogContent className="bg-rosewine text-white max-h-screen overflow-auto">
...
function WalletRow({ wallet, onConnect }: WalletRowProps) {
  return (
    <WalletItem
      wallet={wallet}
      onConnect={onConnect}
       className="bg-violet border border-fuchsia text-white hover:bg-indigoDark"
    >
